...
class TTP_Addon_SDK {
	 ...
	 *
	 * Order: Black Friday (10), license (20), logger addon via TTP_Addon_Loader (22), surveys (30), install timestamp (40), force license refresh (41).
	 *
	 * @return void
	 */
	public static function register_hooks() {
		...
		add_action( 'ttp_register_items', array( $licensing, 'register_force_license_refresh' ), 41 );
	}
}
